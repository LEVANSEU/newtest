...
# Create tabs
tabs = st.tabs(["მთავარი", "დამატებითი"])

with tabs[0]:  # Main tab with existing functionality
...
with tabs[1]:  # Additional tab (empty for now)
    st.write("ეს არის დამატებითი ტაბი. გთხოვთ, მითხრათ, რა ფუნქციონალი გსურთ აქ!")
